...
datapath <- '~/Benslab/project_LANGLIE/Batchalyze/'
...
print(rgx)
df <- read_all_recordings(paste0(datapath, 'ERA/'), rgx, 'txt', delim = "\t")
...
ggsave(paste0(datapath, 'Figures/', typstr, '_', T1toT2, '-CDA-nSCR'), device = 'png')
...
ggsave(paste0(datapath, 'Figures/', typstr, '_', T1toT2, '-CDA-Latency'), device = 'png')
...
ggsave(paste0(datapath, 'Figures/', typstr, '_', T1toT2, '-CDA-SCR'), device = 'png')
...
ggsave(paste0(datapath, 'Figures/', typstr, '_', T1toT2, '-CDA-PhasicMax'), device = 'png')
...
ggsave(paste0(datapath, 'Figures/', typstr, '_', T1toT2, '-CDA-Tonic'), device = 'png')
...
ggsave(paste0(datapath, 'Figures/', typstr, '_', T1toT2, '-GlobalMean'), device = 'png')
# }