...
method <- "var" # options are: max, mean, median, min, prod, sd, sum, var; see ?RcppRoll
REPS <- 10000
```
...
```{r sldgwndw}
# Db6m.pr1.1 <- corr_rollme_1pr(df, 1, 1, feature, wndw, step)
# Db6m.corr <- corr_rollme_allpr(df, feature, wndw, step)

Db6m.cormat <- corr_rollme_mat(df, feature, wndw, step, method, FALSE)
...
De6m.cor <- cond2cormat(basepath, patts, feature, wndw, step, method, triangle = FALSE)
# Permutation testing
...
patts <- c(paste0(paircond[1], '_', cond_str), paste0(paircond[2], '_', cond_str))
Dr6m.cor <- cond2cormat(basepath, patts, feature, wndw, step, method, triangle = FALSE)
# Permutation testing
...
patts <- c(paste0(paircond[1], '_', cond_str), paste0(paircond[2], '_', cond_str))
Dn6m.cor <- cond2cormat(basepath, patts, feature, wndw, step, method, triangle = FALSE)
# Permutation testing
...
patts <- c(paste0(paircond[1], '_', cond_str), paste0(paircond[2], '_', cond_str))
Sb6m.cor <- cond2cormat(basepath, patts, feature, wndw, step, method, triangle = FALSE)
# Permutation testing
...
patts <- c(paste0(paircond[1], '_', cond_str), paste0(paircond[2], '_', cond_str))
Se6m.cor <- cond2cormat(basepath, patts, feature, wndw, step, method, triangle = FALSE)
# Permutation testing
...
patts <- c(paste0(paircond[1], '_', cond_str), paste0(paircond[2], '_', cond_str))
Sr6m.cor <- cond2cormat(basepath, patts, feature, wndw, step, method, triangle = FALSE)
# Permutation testing
...
patts <- c(paste0(paircond[1], '_', cond_str), paste0(paircond[2], '_', cond_str))
Sn6m.cor <- cond2cormat(basepath, patts, feature, wndw, step, method, triangle = FALSE)
# Permutation testing
